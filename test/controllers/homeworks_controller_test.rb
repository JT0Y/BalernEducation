...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { : @homework., due: @homework.due, group_id: @homework.group_id, instructions: @homework.instructions, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { : @homework., due: @homework.due, group_id: @homework.group_id, instructions: @homework.instructions, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
